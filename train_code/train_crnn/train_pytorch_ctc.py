...
from train_code.train_crnn import utils
from train_code.train_crnn import mydataset
from train_code.train_crnn import crnn as crnn
from train_code.train_crnn import config
from  train_code.train_crnn.online_test import val_model
config.imgW = 800
